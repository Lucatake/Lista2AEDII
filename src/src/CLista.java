...
/////////////////////////////////////////////////////////////////
	...
	/**
	 * Método para inserir antes de - Exercicio 1
	...
	**/
	...
	/**
	 * Método para inserir depois de - Exercicio 2
	...
	**/
	...
	/**
	 * Método para inserir em ordem crescente - Exercicio 3
	...
	**/
	...
	/**
	 * Método para remover item na n-ésima posição - Exercicio 11
	...
	**/
	public Object[] copiaParaVetor() {
		...
		int i = 0;
		for (CCelula aux = primeira.prox; aux != null; aux = aux.prox, i++)
			vector[i] = aux.item;
		return vector;
	}
